...
export class ViewProfileComponent {
  ...
  constructor(private router: Router,private http: HttpClient,private fb:FormBuilder,
    private  _customerservice:OutputProfileService
    ){
    ...
    ngOnInit(): void {
      ...
      { headerName: '',headerCheckboxSelection: true,
        ...
        { headerName: 'ProfileId',field: 'profileId'},
      { headerName: 'Name',field: 'name'},
      { headerName: 'PropertyValue',field: 'propertyValue'},
    ...
    onGridReady(params: GridReadyEvent) {
      ...
      this.rowData$ = this.http.get<any[]>(Constants.WIT_API_ENDPOINT+Constants.LIFT_API_GET_PROFILEBYPROFILEID+this.cityForm.get('Name')?.value);
    ...
    onCellClicked(e:any): void {
      ...
      {        
        this.router.navigate(['/addApplicationVariable'], { queryParams: { Id: e.data.id } });
    ...
    BackToAddProfile()
  {
    this.router.navigate(['/addApplicationVariable']);
  }
  SearchProfile()
  {
    this.rowData$ = this.http.get<any[]>(Constants.WIT_API_ENDPOINT+Constants.LIFT_API_GET_PROFILEBYPROFILEID+this.cityForm.get('Name')?.value);
